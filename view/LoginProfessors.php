...
<body>
    ...
    <div id="container">
        <form action="../controller/LoginProfessors.php" method="post">
            ...
            <h5><a href="mdpoProfessors.php"> Mot<b>_</b>de<b>_</b>passe<b>_</b>oublié<b>_</b>? </a></h5>
            <h5 id="signup"><a href="createAccountProfessors.php"> Créer<b>_</b>un<b>_</b>compte </a></h5><br>
