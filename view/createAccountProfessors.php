...
<div id="container">
    ...
    <div id="formulaire">
        <form action="../controller/CreateAccountProfessors.php" method="post">
            <h1>S'inscrire</h1>
            ...
            <input type="radio" name="sex" id="masculin">Masculin <br>
            <input type="radio" name="sex" id="feminin">Féminin
            <br><br>

            <input type="submit" id='submit' value="SOUMETTRE L'INSCRIPTION" >
            <h4><a href="MdpoProf.php"> Mot de passe oublié ? </a></h4>
            <h4 id="aide"><a href="AideNC.php"> Aide(?) </a></h4>
            <h1 id="login"><a href="../accueilProfessors.php"> Se<b>_</b>connecter</a></h1>
        </form>
    </div>
